...
const sections = [
  ...
  },
  {
    ...
    title: 'Nosotros',
    subtitle: '',
    body: 'Explore Occidente Costa Rica es una plataforma de la Fundación Bosque Nuboso de Occidente, que busca apoyar la consolidación de emprendimientos turísticos de la región de Occidente, a través del mercadeo digital, capacitación y operación turística. Le invitamos a conocer la gran variedad de actividades ecoturísticas que existen en la región de Occidente.',
  ...
  },
  {
    ...
    subtitle: '',
    body: 'La Red de Turismo Sostenible es un conjunto de emprendimientos ecoturísticos que muestran la riqueza de la biodiversidad de la región de Occidente. La red ofrece a los visitantes la oportunidad de vivir experiencias de turismo auténticas y sostenibles por medio de actividades como la observación de aves, senderismo, visitas a cataratas, contemplación de paisajes, alojamientos, actividades de aventura y experimentación de la cultura y gastronomía local.',
    ctaText: '',
    ctaLink: '',
    isVisible: true,
    extraData: {},
  },
  {
    ...
    subtitle: '',
    body: 'El mapa de la Red de Turismo Sostenible contiene información de la ubicación de los sitios de hospedaje, tours, actividades y otros elementos complementarios de la actividad turística, facilitando la interacción entre visitantes y los sitios que forman parte de la red.',
    ctaText: '',
    ctaLink: '',
    isVisible: true,
    extraData: {
  ...
  },
  {
    ...
    title: 'Contacto',
    subtitle: '',
    body: 'Escríbanos qué actividades le gustaría hacer o en qué lugar le gustaría hospedarse y con gusto le atenderemos.',
    ctaText: 'Enviar',
    ctaLink: '',
    isVisible: true,
    extraData: {
...
const images = [
  // Hero
  {
    ...
    section: 'hero',
    role: 'hero',
    alt: 'Bosque nuboso de Occidente Costa Rica',
    linkUrl: '',
    order: 1,
    isActive: true,
  },
  // Nosotros — logo Fundación
  {
...
const redItems = [
  {
    label:    'Hospedajes',
    href:     'http://exploreoccidentecr.com/Cliente/Hospedaje',
    type:     'internal',
    iconUrl:  '',
    order:    1,
    isActive: true,
  ...
  {
    label:    'Sitios de Recreación',
    href:     'http://exploreoccidentecr.com/Cliente/ToursActivities',
    type:     'internal',
    iconUrl:  '',
    order:    2,
    isActive: true,
  },
  {
    ...
    href:     'http://exploreoccidentecr.com/imagenes/Docs/Observacion_Aves.pdf',
    type:     'pdf',
    iconUrl:  '',
    order:    3,
    isActive: true,
  ...
  {
    label:    'Senderismo',
    href:     'http://exploreoccidentecr.com/imagenes/Docs/Senderismo.pdf',
    type:     'pdf',
    iconUrl:  '',
    order:    4,
    isActive: true,
  ...
  {
    label:    'Chapulitour',
    href:     'http://exploreoccidentecr.com/Cliente/Chapulitour',
    type:     'internal',
    iconUrl:  '',
    order:    5,
    isActive: true,
  ...
  {
    label:    'Restaurantes y miradores',
    href:     'http://exploreoccidentecr.com/Cliente/ElementosComplementarios',
    type:     'internal',
    iconUrl:  '',
    order:    6,
    isActive: true,
